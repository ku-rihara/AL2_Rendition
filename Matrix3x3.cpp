...
Vertex Transform(Vertex VerTexWide, Matrix3x3 matrix) {
	...
	float leftTopw = result.LeftTop.x * matrix.m[0][2] + result.LeftTop.y * matrix.m[1][2] + 1.0f * matrix.m[2][2];
	...
	float RightTopw = result.RightTop.x * matrix.m[0][2] + result.RightTop.y * matrix.m[1][2] + 1.0f * matrix.m[2][2];
	...
	float LeftBottomw = result.LeftBottom.x * matrix.m[0][2] + result.LeftBottom.y * matrix.m[1][2] + 1.0f * matrix.m[2][2];
	...
	float RightBottomw = result.RightBottom.x * matrix.m[0][2] + result.RightBottom.y * matrix.m[1][2] + 1.0f * matrix.m[2][2];
